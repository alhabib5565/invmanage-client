...
import {
  ...
  bookSaleFormSchema,
} from "./saleEntry.validation";
import CreateCustomerModal from "@/components/pages/dashboard/admin/admin-book-sale/CreateCustomerModal";
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <MyInput name="paidAmount" label="Paid Amount" type="number" />
